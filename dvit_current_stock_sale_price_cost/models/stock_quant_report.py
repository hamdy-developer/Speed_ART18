...
class StockQuantReport(models.Model):
    ...
    def _select(self):
        return """
            SELECT
                ...
                sq.inventory_quantity_auto_apply - reserved_quantity as product_qty,
                sq.location_id,
                pt.list_price as price_unit,
                pt.standard_price as standard_price,  -- استخدام standard_price من product_template
    ...
    def _from(self):
        return """
            ...
            LEFT JOIN product_template as pt ON pt.id = sq.product_tmpl_id  -- استخدام join مع product_template
        """
    ...
    def _group_by(self):
        return """
            GROUP BY
                ...
                sq.location_id,
                pt.list_price,
                pt.standard_price  -- استخدام pt.standard_price
        """
